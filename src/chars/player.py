...
class Player:
    def __init__(self, idle_sprite_sheet_path, move_sprite_sheet_path, jump_sprite_sheet_path, position, map, player_size=GameConfig.PLAYER_SIZE_48, scale_factor=GameConfig.SCALE_FACTOR):
        self.frame_index = 0
        ...
        self.jump_animation = Animation(jump_sprite_sheet_path, GameConfig.PLAYER_WIDTH, GameConfig.PLAYER_HEIGHT, scale_factor)
