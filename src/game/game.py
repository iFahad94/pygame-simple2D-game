...
class Game:
    def __init__(self, screen):
        ...
        self.player = Player(GameConfig.PLAYER_SPRITESHEET_IDLE_PATH, GameConfig.PLAYER_SPRITESHEET_PATH,GameConfig.PLAYER_SPRITESHEET_PATH, GameConfig.PLAYER_START_POSITION, 48)
